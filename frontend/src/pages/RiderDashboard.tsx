...
const RiderDashboard = () => {
  ...
  const handleSubmit = async () => {
    ...
    navigator.geolocation.getCurrentPosition(async (pos) => {
      ...
      try {
        console.log("Submitting rider profile to:", `${riderService}/api/rider/new`);
        ...
        console.log("Rider registration error:", error);
        ...
        if (error.response) {
          ...
          toast.error(error.message || "Network error - is the rider service running?");
        }
      } finally {
        setSubmitting(false);
      }
